...
sealed class Message {
    ...
    sealed class Option {
        ...
        data class Oscore(
            ...
            override fun equals(other: Any?): Boolean =
                this === other ||
                        (other is Oscore && partialIv.contentEquals(other.partialIv) &&
                            kidContext.contentEquals(other.kidContext) && kid.contentEquals(other.kid))
            ...
            companion object {
                fun fromOptionValue(value: ByteArray): Oscore {
                    ...
                    val kidContext = if (kidContextFlag) value.sliceArray(2 + partialIvLength until 2 + partialIvLength + kidContextLength) else null
